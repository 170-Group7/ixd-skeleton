...
var friendDiv = '<div class="list-group-item">' +
				'	<p class="username"></p>' +
				'</div>';
const CHEV_RIGHT = '<svg id="chev-right" style="width:24px;height:24px" viewBox="0 0 24 24">' +
			    ...
			    '</svg>';
const CHEV_DOWN = '<svg id="chev-down" style="width:24px;height:24px" viewBox="0 0 24 24">' +
